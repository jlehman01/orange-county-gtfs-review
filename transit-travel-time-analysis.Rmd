...
After changes were implemented in GTFS feed as suggested in the GTFS Recommendations section of this report, transit networks were built using the GTFS feeds and the OSM walk network. Transit travel time contours were developed for five locations throughout the region, representing travel time from one point to areas accessible by up to 90 minutes by any combination of walking and transit travel time.
